...
# ============================================================
#  LIENS DU SITE OFFICIEL — modifie ici si besoin
# ============================================================
SITE_LINKS = {
    ...
    "podcasts":   ("Podcasts",              "https://freedom.fr/podcasts/"),
    "club":       ("Freedom Club",          "https://freedom.fr/category/freedom-club/"),
    "sport":      ("Sport",                 "https://freedom.fr/category/sport/"),
    "culture":    ("Culture",               "https://freedom.fr/category/culture/"),
    "contact":    ("Contact",               "https://freedom.fr/contact/"),
}
...
class Visualizer(QWidget):
    ...
    def paintEvent(self, event):
        ...
        grad.setColorAt(0.5, QColor(0, 229, 255, 140))
        grad.setColorAt(1.0, QColor(0, 229, 255, 40))
...
class SitePopup(QDialog):
    """
    Popup modal frameless, même design que la fenêtre principale.
    Propose d'ouvrir les différentes sections du site freedom.fr.
    """
    def __init__(self, parent=None):
        super().__init__(parent)
        ...
        # Position au centre de la fenêtre parente
        if parent:
            geo = parent.geometry()
        ...
        # --- Pied : bouton "Tout ouvrir" + "Fermer" ---
        foot = QHBoxLayout()
        foot.setSpacing(6)
    ...
    def _open_all(self):
        for key in ("site", "radio1", "radio2", "podcasts", "club"):
            if key in SITE_LINKS:
                _, url = SITE_LINKS[key]
                webbrowser.open(url)
        self.accept()
...
class Freedom(QMainWindow):
    def __init__(self):
        ...
        self.stations.setMaximumHeight(90)
